...
def nba_cup(result_sheet, to_find)
  ...
  "#{to_find}:W=#{win};D=#{draw};L=#{loss};Scored=#{scored};Conceded=#{conceded};Points=#{win*3 + draw*1}"
end

    puts nba_cup(testList, " San Antonio Spurs")
